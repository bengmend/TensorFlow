...
class ConvertToListOfSparseCoreCooTensorsOp : public OpKernel {
 ...
 private:
  ...
  int sample_count_ = 1;
  int num_sc_per_chip_ = 1;
  int per_sc_sample_count_ = 1;
  int row_offset_ = 0;
  int col_offset_ = 0;
  int col_shift_ = 0;
  int num_sc_shards_;
...
class SortListOfSparseCoreCooTensorsOp : public OpKernel {
 ...
 private:
  ...
  int feature_width_ = 1;
  int num_replica_ = 1;
  int32_t num_physical_replica_ = 1;
  int32_t num_physical_replica_bit_ = 1;
  int32_t max_ids_per_sparse_core_;
  int32_t max_unique_ids_per_sparse_core_;
  std::string table_name_;
  std::vector<int> sample_count_list_;
  std::vector<int> col_offset_list_;
